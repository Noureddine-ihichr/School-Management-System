...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="font-semibold text-xl text-gray-800">{{ $stats['teachers'] }}</h2>
        ...
        <!-- Admins Card (Only visible to Super Admin) -->
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="font-semibold text-xl text-gray-800">{{ $stats['admins'] }}</h2>
