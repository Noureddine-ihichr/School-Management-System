            ...
            <form action="{{ route('classes.update', ['class' => $class->id]) }}" method="POST">
                ...
                <div class="mb-6" x-data="{ 
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <label class="text-lg font-semibold text-gray-900">Assigned Teachers</label>
                        <button type="button" 
                        ...
                        <template x-for="teacher in selectedTeachers" :key="teacher.id">
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-3" x-text="`${teacher.first_name} ${teacher.last_name}`"></span>
                                </div>
                                <button type="button" 
                                        @click="selectedTeachers = selectedTeachers.filter(t => t.id !== teacher.id)"
