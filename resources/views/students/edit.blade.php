                    ...
                    <div class="flex items-center space-x-6">
                        <div class="shrink-0">
                            @if($student->profile_picture)
                                <img class="h-16 w-16 rounded-full object-cover" src="{{ asset('storage/' . $student->profile_picture) }}" alt="Current profile picture">
                            @else
                    ...
                    <div class="relative">
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <textarea name="address" id="address" rows="3"
                                class="pl-10 block w-full rounded-lg border-gray-300 bg-gray-50 focus:ring-2 focus:ring-indigo-600 focus:border-transparent"
                                placeholder="Enter address" required>{{ old('address', $student->address) }}</textarea>
                        </div>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="relative">
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <textarea name="extra_info" id="extra_info" rows="3"
                                class="pl-10 block w-full rounded-lg border-gray-300 bg-gray-50 focus:ring-2 focus:ring-indigo-600 focus:border-transparent"
                                placeholder="Enter any additional information">{{ old('extra_info', $student->extra_info) }}</textarea>
                        </div>
                        @error('extra_info')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
